# main file to perform image-to-text generation using LLaVA and Safe-CLIP as visual encoder.
...
def eval_model(args):
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(
        ...
        our_vision_encoder=args.our_vision_encoder, ve_name=args.ve_name)
    ...
    keywords = [stop_str] #keywords = [stop_str, tokenizer.pad_token]
